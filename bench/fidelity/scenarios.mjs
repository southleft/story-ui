...
export const scenarios = [
  /* ------------------------------------------------------------ new */
  {
    ...
    expect: {
      mustUseComponents: ['Card', 'Button', 'Accordion'],
      mustUseAnyOf: [['SimpleGrid', 'Grid', 'Group'], ['Badge', 'Pillbox']],
  ...
  },
  {
    ...
    expect: {
      mustUseComponents: ['TextInput', 'Menu'],
      mustUseAnyOf: [['Select', 'SegmentedControl', 'NativeSelect'], ['Table', 'Datagrid'], ['Badge', 'Pillbox']],
  ...
  },
  {
    ...
    expect: {
      mustUseComponents: ['Text'],
      mustUseAnyOf: [['Card', 'Statlet', 'Slab', 'Paper'], ['SimpleGrid', 'Grid'], ['Timeline', 'List', 'Stack'], ['SegmentedControl', 'Tabs', 'Select', 'Button']],
  ...
  },
  {
    ...
    expect: {
      mustUseComponents: ['Card', 'Avatar'],
      mustUseAnyOf: [['SimpleGrid', 'Grid', 'Group', 'Flex'], ['Badge', 'Pillbox']],
  ...
  },
  {
    ...
    expect: {
      mustUseComponents: ['Button'],
      mustUseAnyOf: [['Avatar', 'ThemeIcon'], ['Indicator', 'Badge', 'Pillbox', 'Box', 'ColorSwatch']],
  ...
  },
  {
    ...
    expect: {
      mustUseComponents: ['Pagination'],
      mustUseAnyOf: [['SimpleGrid', 'Grid'], ['Table', 'Datagrid'], ['Badge', 'Pillbox']],
