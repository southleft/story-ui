...
exports.IconGuidanceSystem = void 0;
exports.getIconGuidance = getIconGuidance;
exports.generateIconGuidancePrompt = generateIconGuidancePrompt;
class IconGuidanceSystem {
    constructor() {
        // Component types that should ALWAYS use proper icons
        this.alwaysIconComponents = [
            {
     ...
     */
    getIconGuidance(classification, availableIconLibraries = ['@tabler/icons-react'], userPrompt) {
     ...
     */
    selectBestIconLibrary(libraries) {
        const priorityOrder = [
            '@tabler/icons-react',
            'lucide-react',
            '@heroicons/react',
    ...
    analyzeUserContext(prompt) {
        ...
        const professionalScore = professionalIndicators.filter(indicator => lowerPrompt.includes(indicator)).length;
        const casualScore = casualIndicators.filter(indicator => lowerPrompt.includes(indicator)).length;
        let reasoning = '';
     ...
     */
    getIconExamples(library, category) {
        const baseExamples = {
            '@tabler/icons-react': [
        ...
        return baseExamples[library] || baseExamples['@tabler/icons-react'];
    }
    /**
     * Gets emoji examples that should be avoided in professional contexts
     */
    getEmojiExamples(category) {
        const emojiExamples = {
        ...
        return emojiExamples[category] || emojiExamples.default;
    }
    /**
     * Generates guidance prompt text for AI
     */
    generateGuidancePrompt(componentName, description, userPrompt, availableIconLibraries = ['@tabler/icons-react']) {
...
exports.IconGuidanceSystem = IconGuidanceSystem;
/**
 * Convenience function to get icon guidance for a component
 */
function getIconGuidance(componentName, description, userPrompt, availableIconLibraries) {
 ...
 */
function generateIconGuidancePrompt(componentName, description, userPrompt, availableIconLibraries) {
    const system = new IconGuidanceSystem();
