...
const iconGuidanceSystem_js_1 = require("../story-generator/iconGuidanceSystem.js");
console.log('🎯 Smart Icon Guidance System Examples\n');
const system = new iconGuidanceSystem_js_1.IconGuidanceSystem();
// Example 1: Professional Dashboard
console.log('=== Example 1: Professional Dashboard ===');
const dashboardPrompt = system.generateGuidancePrompt('dashboard', 'user analytics dashboard', 'create a business dashboard with user metrics and charts', ['@tabler/icons-react']);
console.log(dashboardPrompt);
console.log('\n' + '='.repeat(60) + '\n');
// Example 2: Recipe Card  
console.log('=== Example 2: Food Recipe Card ===');
const recipePrompt = system.generateGuidancePrompt('recipe card', 'food recipe display', 'create a pizza recipe card with cooking time and ingredients', ['@tabler/icons-react']);
console.log(recipePrompt);
console.log('\n' + '='.repeat(60) + '\n');
// Example 3: Navigation Component
console.log('=== Example 3: Navigation Menu ===');
const navPrompt = system.generateGuidancePrompt('navigation menu', 'main site navigation', 'create a responsive navigation menu with user profile', ['@tabler/icons-react']);
console.log(navPrompt);
console.log('\n' + '='.repeat(60) + '\n');
// Example 4: Ambiguous Context
console.log('=== Example 4: Ambiguous Context ===');
const ambiguousPrompt = system.generateGuidancePrompt('card', 'generic card component', 'create a card component', ['@tabler/icons-react']);
console.log(ambiguousPrompt);
console.log('\n' + '='.repeat(60) + '\n');
// Example 5: Social Media Component
console.log('=== Example 5: Social Media Post ===');
const socialPrompt = system.generateGuidancePrompt('social post', 'social media interaction', 'create a social media post with likes and comments', ['@tabler/icons-react']);
